...
<html lang="en">
    <head>
        <title>Отдел автоматизации и внедрения новых технологий</title>
        <meta charset="utf-8">
    ...
    <body>
        <div class="wrap">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-7">
                        <div class="text-dark mt-3">
                            <p class="mb-4 text-primary">Отдел автоматизации и внедрения новых технологий</p>
                            <p class="mb-2"><mark>Начальник</mark> – <i>Волчок Сергей Федорович</i>, тел. 29 88 01</p>
                            <p class="ml-3 mb-2"><mark>Зам. начальника</mark> – <i>Федотов Андрей Валерьевич</i>, тел. 29 87 39;</p>
                        </div>
                    </div>
                ...
                <div class="row mt-3">
                    <div class="col-7">
                        <p>Работа отдела направлена на:</p>
                        <ul>
                            <li>определение  и осуществление единой технической политики и перспективы развития автоматизации производства общества, внедрение новых средств автоматизации, технических средств АСУТП, координацию деятельности по этим направлениям рудоуправлений и других подразделений общества;</li>
                            <li>разработку перспективных планов по автоматизации производственных процессов, научно-исследовательских и опытно-конструкторских работ;</li>
                            <li>разработку технических заданий на средства автоматизации и средства измерений, ведение альбома типовых технических заданий;</li>
                            <li>организацию испытаний и внедрение новых средств измерений и средств автоматизации с целью повышения эффективности производства и качества продукции.</li>
                        </ul>
                    </div>
                    <div class="col-3">
                    </div>
